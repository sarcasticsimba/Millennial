...
test:
	./mill testfiles/oprah.jpg ./testimg_oprah_meme.png You get a meme, you get\
 a meme, ---- EVERYONE GETS A MEME!
...
run:
	...
	make test_bot; make test_bot_short; make no_caption; make url
